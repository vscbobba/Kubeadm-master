resource "aws_instance" "kubeadm-worker" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "sudo mkdir -p /mnt/data/sonarqube/data",
      "sudo mkdir -p /mnt/data/sonarqube/logs",
      "sudo mkdir -p /mnt/data/sonarqube/extensions",
